                        ...
                        const float &AI_Throttle, const int16_t &PWM_Throttle)
{
    ...
    struct log_AIDeflection pkt = {
        ...
        normalizedElevator : AI_Elevator,
        pwmElevator : PWM_Elevator,
        normalizedRudder : AI_Rudder,
        pwmRudder : PWM_Rudder,
